...
// .env is loaded by index.js before this file is imported
...
let chatIdToSessionId = new Map();
const OTP_EXPIRY = 5 * 60 * 1000;

if (!process.env.TELEGRAM_BOT_TOKEN) {
  console.error('[Bot] WARNING: TELEGRAM_BOT_TOKEN is not defined in .env file. Bot will not start.');
  // Don't exit - let the server start without the bot
} else {
